	...
	<div class="container">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<option selected >Chọn Danh Mục Của Sản Phẩm</option>
				...
				<button type="submit" class="btn btn-primary"style="float:right;margin: 15px 15px;" >Xem</button>
			</div>
				</form>
			
				<a href="add.php">
					<button class="btn btn-success" style="margin: 15px;">Thêm Sản Phẩm</button>
				</a>
